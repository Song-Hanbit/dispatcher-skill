...
- `dispatcher-app.md`: current Python server behavior, SQLite state, UI, auth, and verification flow.
...
- `decisions.md`: accepted design decisions and rejected/ deferred alternatives.
